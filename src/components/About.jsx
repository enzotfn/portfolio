...
import profilePic from '../assets/profil_pic.jpg';
import './About.css';
    ...
    <section className="about section" id="about" ref={sectionRef} aria-label="About me">
      <div className="about-container">
        ...
        <div className="about-grid">
          {/* Profile card — viewfinder style */}
          <div className="about-profile reveal-left">
            <div className="viewfinder">
              ...
              <img className="profile-picture" src={profilePic} alt="Enzo Tofani" />
              <div className="viewfinder-data" aria-hidden="true">
                <span>REC ●</span>
                <span>F/2.8</span>
              </div>
            </div>
          ...
          <div className="about-info">
            <div className="about-bio glass-card reveal-right">
            ...
            <div className="about-details reveal">
              ...
              <div className="detail-item">
                ...
                <div className="detail-content">
                  ...
                  <a href={`tel:${personalInfo.phone}`} className="detail-value">
                    {personalInfo.phone}
                  </a>
                </div>
              </div>
              ...
              <div className="detail-item">
                ...
                <div className="detail-content">
                  ...
                  <span className="detail-value">{personalInfo.birthday}</span>
                </div>
              </div>
