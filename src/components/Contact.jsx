    ...
    >
      <div className="contact-container">
        ...
        <div className="contact-grid">
          ...
          {/* Map */}
          <div className={`contact-map ${isVisible ? 'visible' : ''}`}>
            <div className="map-wrapper glass-card">
              <iframe
                ...
                title="Location - Polytech Nantes"
              />
            </div>
          </div>
        </div>
        ...
        <footer className="portfolio-footer">
          ...
          <p className="footer-text">
            <span className="footer-name">Enzo Tofani</span>
            <span className="footer-separator">·</span>
            <span className="footer-year">© {new Date().getFullYear()}</span>
            <span className="footer-separator">·</span>
            <span className="footer-tag">Crafted with passion for art & code</span>
          </p>
        </footer>
      </div>
    </section>
